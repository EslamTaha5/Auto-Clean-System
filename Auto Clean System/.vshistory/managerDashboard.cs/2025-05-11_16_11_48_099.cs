    ...
    public partial class managerDashboard : Form {
        ...
        private void loadServicesIntoComboBox() {
            try {
                ...
                combServiceNameOrder.Items.Clear();

                // Get services data from the database
                var services = this.autoCleanDatabaseDataSet.Services;

                // Set up the ComboBox data binding
                combServiceNameOrder.DataSource = services;
                combServiceNameOrder.DisplayMember = "ServiceName";  // The column name to display
                combServiceNameOrder.ValueMember = "ServiceID";     // The underlying value
                
                // Optional: Add a default empty item
                combServiceNameOrder.Items.Insert(0, new { ServiceName = "-- Select Service --", ServiceID = 0 });
