...
namespace Auto_Clean_System
{
    public partial class managerDashboard : Form
    {
        ...
        private void btnSearchCustomer_Click(object sender, EventArgs e) {
            ...
            string customerCarString = customerPhone.Text;
            if (int.TryParse(customerCarString, out int CustomerIdNum)) {
                ...
                this.customerTableAdapter.FindCustomerByNameAndCar(autoCleanDatabaseDataSet.Customer, customerNameString, customerCarString, -1);
            }
        }
