...
namespace Auto_Clean_System
{
    public partial class managerDashboard : Form
    {
        ...
        private void servicesDataGridView_CellContentClick(object sender, DataGridViewCellEventArgs e) {
            ...
            serviceId.Text = selRow.Cells["StandardIDCol"].Value.ToString();
            serviceName.Text = selRow.Cells["ServiceNameCol"].ToString();
            serviceCost.Text = selRow.Cells["StandardCostCol"].ToString();
