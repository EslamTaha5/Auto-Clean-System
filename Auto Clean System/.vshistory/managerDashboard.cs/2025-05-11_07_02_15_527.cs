...
namespace Auto_Clean_System
{
    public partial class managerDashboard : Form
    {
        ...
        StaffClass checkUser() {
            ...
            StaffClass user = new StaffClass(name, userID, userSalary, userBonus, new DateTime(), password, 0);
            return user;
        }
        void insertIntoDataBase() {
            Console.WriteLine(staffUser.hireDate.ToString());
            return;
            Program.StaffAdapter.insertEmployee(staffUser.staffID, staffUser.name, staffUser.password, staffUser.salary, staffUser.bonus, staffUser.hireDate.ToString(), staffUser.isManager);
        }
