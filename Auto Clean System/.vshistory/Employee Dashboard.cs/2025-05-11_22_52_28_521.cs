...
namespace Auto_Clean_System {
    public partial class EmployeeDashboard : Form {
        ...
        OrderPage getOrderData() {
            ...
            Console.WriteLine(combServiceNameOrder.SelectedItem.ToString());

            orderPage.ServiceName = combServiceNameOrder.SelectedItem.ToString();
        ...
        private void addOrderBtn_Click_1(object sender, EventArgs e) {
            ...
            Console.WriteLine("Inserting Order Details");
            insertOrder(order);
