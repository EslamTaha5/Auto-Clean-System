...
namespace Auto_Clean_System
{
    public partial class managerLogin : Form
    {
        ...
        {
            var newStaff = Program.AppDataSet.Staff.NewStaffRow();
            newStaff.StaffID = 12345;
            newStaff.Password = "12345";
            newStaff.NAME = "Eslam";
            newStaff.IsManager = 1; // Or your manager flag
            Program.AppDataSet.Staff.AddStaffRow(newStaff);
            Program.SaveAllData(); // Critical: Save to database
