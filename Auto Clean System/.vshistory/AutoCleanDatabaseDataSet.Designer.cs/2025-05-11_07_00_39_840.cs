...
SELECT StaffID, NAME, Password, Salary, Bonus, HireDate, IsManager FROM Staff WHERE (StaffID = @StaffID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[4].CommandText = @"INSERT INTO [dbo].[Staff] ([StaffID], [NAME], [Password], [Salary], [Bonus], [HireDate], [IsManager]) VALUES (@StaffID, @NAME, @Password, @Salary, @Bonus, @HireDate, @IsManager);
SELECT StaffID, NAME, Password, Salary, Bonus, HireDate, IsManager FROM Staff WHERE (StaffID = @StaffID)";
            ...
            this._commandCollection[5].CommandText = "SELECT StaffID, NAME, Password, Salary, Bonus, HireDate, IsManager FROM dbo.Staff" +
                "\r\nwhere isManager = 0\r\n";
        ...
        public virtual int insertEmployee(long StaffID, string NAME, string Password, global::System.Nullable<decimal> Salary, global::System.Nullable<decimal> Bonus, string HireDate, int IsManager) {
            ...
            command.Parameters[6].Value = ((int)(IsManager));
            global::System.Data.ConnectionState previousConnectionState = command.Connection.State;
            if (((command.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                command.Connection.Open();
