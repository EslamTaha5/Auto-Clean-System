...
SELECT OrderID, CustomerID, EmployeeID, CarName, OrderDate, CostBeforeDiscount, TotalDiscount, CostAfterDiscount FROM Orders WHERE (OrderID = SCOPE_IDENTITY())";
        ...
        internal void insertOrder(int customerID, long employeeID, string carName, decimal cost, decimal discount, int totalCost) {
            throw new NotImplementedException();
        }

        internal void insertOrder(int customerID, long employeeID, string carName, decimal cost, decimal discount, decimal totalCost) {
            throw new NotImplementedException();
        }
    }
