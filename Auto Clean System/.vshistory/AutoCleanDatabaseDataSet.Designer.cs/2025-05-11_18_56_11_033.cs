...
SELECT OrderID, NumberOfServices, CustomerID, EmployeeID, CarName, OrderDate, CostBeforeDiscount, TotalDiscount, CostAfterDiscount FROM Orders WHERE (OrderID = SCOPE_IDENTITY())";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, false)]
        public virtual int insertOrder(int CustomerID, long EmployeeID, string CarName, decimal CostBeforeDiscount, global::System.Nullable<decimal> TotalDiscount, decimal CostAfterDiscount) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[1];
            ...
            command.Parameters[3].Value = ((decimal)(CostBeforeDiscount));
            if ((TotalDiscount.HasValue == true)) {
            ...
            command.Parameters[5].Value = ((decimal)(CostAfterDiscount));
            global::System.Data.ConnectionState previousConnectionState = command.Connection.State;
            if (((command.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                command.Connection.Open();
