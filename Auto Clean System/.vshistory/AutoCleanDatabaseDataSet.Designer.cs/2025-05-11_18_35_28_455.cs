...
SELECT CustomerID, Name, PhoneNumber, Car FROM Customer WHERE (CustomerID = @CustomerID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@car", global::System.Data.SqlDbType.VarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "Car", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[2].CommandText = "INSERT INTO [dbo].[Customer] ([Name], [PhoneNumber], [Car]) VALUES (@Name, @Phone" +
                "Number, @Car);\r\nSELECT CustomerID, Name, PhoneNumber, Car FROM Customer WHERE (C" +
                "ustomerID = SCOPE_IDENTITY())";
            ...
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Car", global::System.Data.SqlDbType.VarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "Car", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        public virtual int FindCustomerByNameAndCar(AutoCleanDatabaseDataSet.CustomerDataTable dataTable, string name, string car, int ID) {
        ...
        public virtual AutoCleanDatabaseDataSet.CustomerDataTable GetDataBy2(string name, string car, int ID) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((name == null)) {
                throw new global::System.ArgumentNullException("name");
            }
        ...
        public virtual int updateCustomer(string Name, long PhoneNumber, string Car, int Original_CustomerID) {
